...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoApplicationApp.country.delete.question">
        <Translate contentKey="demoApplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
