  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demoApplicationApp.job.home.createOrEditLabel">
            <Translate contentKey="demoApplicationApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="jobTitleLabel" for="job-jobTitle">
                  <Translate contentKey="demoApplicationApp.job.jobTitle">Job Title</Translate>
                </Label>
                <AvField id="job-jobTitle" type="text" name="jobTitle" />
              </AvGroup>
              <AvGroup>
                <Label id="minSalaryLabel" for="job-minSalary">
                  <Translate contentKey="demoApplicationApp.job.minSalary">Min Salary</Translate>
                </Label>
                <AvField id="job-minSalary" type="string" className="form-control" name="minSalary" />
              </AvGroup>
              <AvGroup>
                <Label id="maxSalaryLabel" for="job-maxSalary">
                  <Translate contentKey="demoApplicationApp.job.maxSalary">Max Salary</Translate>
                </Label>
                <AvField id="job-maxSalary" type="string" className="form-control" name="maxSalary" />
              </AvGroup>
              <AvGroup>
                <Label for="job-task">
                  <Translate contentKey="demoApplicationApp.job.task">Task</Translate>
                </Label>
                <AvInput
                  id="job-task"
                  type="select"
              ...
              <AvGroup>
                <Label for="job-employee">
                  <Translate contentKey="demoApplicationApp.job.employee">Employee</Translate>
                </Label>
