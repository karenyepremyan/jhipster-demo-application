...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoApplicationApp.department.delete.question">
        <Translate contentKey="demoApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
