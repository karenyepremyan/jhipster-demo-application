...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoApplicationApp.employee.delete.question">
        <Translate contentKey="demoApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
