...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoApplicationApp.jobHistory.delete.question">
        <Translate contentKey="demoApplicationApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
