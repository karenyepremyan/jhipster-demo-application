  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demoApplicationApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="demoApplicationApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="startDateLabel" for="job-history-startDate">
                  <Translate contentKey="demoApplicationApp.jobHistory.startDate">Start Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="endDateLabel" for="job-history-endDate">
                  <Translate contentKey="demoApplicationApp.jobHistory.endDate">End Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="languageLabel" for="job-history-language">
                  <Translate contentKey="demoApplicationApp.jobHistory.language">Language</Translate>
                </Label>
                <AvInput
                  ...
                  className="form-control"
                  name="language"
                  value={(!isNew && jobHistoryEntity.language) || 'ARMENIAN'}
                >
                  <option value="ARMENIAN">{translate('demoApplicationApp.Language.ARMENIAN')}</option>
                  <option value="ENGLISH">{translate('demoApplicationApp.Language.ENGLISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="demoApplicationApp.jobHistory.job">Job</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-department">
                  <Translate contentKey="demoApplicationApp.jobHistory.department">Department</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-employee">
                  <Translate contentKey="demoApplicationApp.jobHistory.employee">Employee</Translate>
                </Label>
