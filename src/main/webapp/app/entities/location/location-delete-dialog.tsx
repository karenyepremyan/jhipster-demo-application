...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoApplicationApp.location.delete.question">
        <Translate contentKey="demoApplicationApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
