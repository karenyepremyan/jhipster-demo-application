  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demoApplicationApp.task.home.createOrEditLabel">
            <Translate contentKey="demoApplicationApp.task.home.createOrEditLabel">Create or edit a Task</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
